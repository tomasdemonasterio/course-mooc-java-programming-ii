...
public class MagicSquare {
    ...
    public ArrayList<Integer> sumsOfDiagonals() {
        ...
        for (int i = 0; i < this.square.length; i++) {
            sumLeftDiagonal += this.square[i][i];
            
        }
        for (int i = 0; i < this.square.length; i++) {
            sumRightDiagonal += this.square[i][this.square.length - i - 1];
            
        }
        
        sumOfDiagonals.add(sumLeftDiagonal);
        sumOfDiagonals.add(sumRightDiagonal);
